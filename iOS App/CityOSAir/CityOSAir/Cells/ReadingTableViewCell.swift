...
class ReadingTableViewCell: UITableViewCell {
    ...
    fileprivate func initialize() {
        ...
        let rightArrow = UIImageView(image: UIImage(named: "rightarrowwhite")?.withRenderingMode(.alwaysTemplate))
        rightArrow.tintColor = UIColor.white.withAlphaComponent(0.71)
